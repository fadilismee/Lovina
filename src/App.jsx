...
import heroImg from "./assets/pics/9.png";
    ...
    <main>
      ...
      >
        ...
        <div className="w-full max-w-screen-2xl px-5 lg:px-10 mb-[5%] flex flex-col gap-3 lg:gap-5 z-10 text-white ">
          ...
          >
           Raden Roro Lovina Allea Putri Nugroho.
          </h1>
          <p
          ...
          >
            Perempuan yang cantik dan juga manis. bertemu sama kamu bukan hal biasa, bertemu dengan mu adalah rezeki tuhan yang diberikan kepadaku. Aku bener bener seneng dan juga bahagia ketemu kamu, sayang.
          </p>
      ...
      <Modal setOpenModal={setOpenModal} openModal={openModal}>
        ...
        <div className="flex flex-col gap-3 lg:gap-5 p-5 text-white">
          <h1 className="font-bold text-2xl">Untuk Wanita Spesial </h1>
          <p>Hi Sayaang...</p>
          <p>
          Akuu buat ini sebagai salah satu bentuk terimakasih-ku ke kamu sayang. Aku bener bener terimakasih kamu selalu mau sama aku, selalu mau bareng sama aku, mau bahagia sedih sama aku, seneng bareng sama aku. Aku bener bener banyak terimakasih ke kamu sayang. Aku juga selalu bangga sama kamu sayang! Aku masih banyak salahnya dan masih banyak kurangnya tapi, kamuu selalu mau melengkapi kekurangan -ku. Aku bener bener banyak terimakasih ke kamu sayang. Emang kamu bener bener rezeki tuhan yang di berikan ke aku. Terimakasih banyak ya sayankuu. Bareng bareng terus sama aku ya sayang! ILOVEYOU SAYANGKU CANTIKKU MANISKU DUNIAKU SEMESTAKUU🤍
